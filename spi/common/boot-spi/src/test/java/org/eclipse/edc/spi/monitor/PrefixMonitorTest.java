...
public class PrefixMonitorTest {
    ...
    @Test
    public void logSevere_byMessageSupplier_logIsDelegated() {
    ...
    @Test
    public void logSevere_byMessageString_logIsDelegated() {
        prefixMonitor.severe(TEST_MESSAGE);
        verify(mockMonitor).severe(eq(EXPECTED_MESSAGE));
    }

    @Test
    public void logWarning_byMessageSupplier_logIsDelegated() {
    ...
    @Test
    public void logWarning_byMessageString_logIsDelegated() {
        prefixMonitor.warning(TEST_MESSAGE);
        verify(mockMonitor).warning(eq(EXPECTED_MESSAGE));
    }

    @Test
    public void logInfo_byMessageSupplier_logIsDelegated() {
    ...
    @Test
    public void logInfo_byMessageString_logIsDelegated() {
        prefixMonitor.info(TEST_MESSAGE);
        verify(mockMonitor).info(eq(EXPECTED_MESSAGE));
    }

    @Test
    public void logDebug_byMessageSupplier_logIsDelegated() {
    ...
    @Test
    public void logDebug_byMessageString_logIsDelegated() {
        prefixMonitor.debug(TEST_MESSAGE);
