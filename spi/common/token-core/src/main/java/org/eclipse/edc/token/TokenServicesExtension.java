...
package main.java.org.eclipse.edc.token;

import main.java.org.eclipse.edc.security.token.jwt.DefaultJwsSignerProvider;
...
import static main.java.org.eclipse.edc.token.TokenServicesExtension.NAME;
...
public class TokenServicesExtension implements ServiceExtension {
    ...
    public DefaultJwsSignerProvider defaultSignerProvider() {
